...
namespace Qualcomm.Snapdragon.Spaces.Samples
{
    public class AnchorSampleController : SampleController
    {
        ...
        private GazeInteractionUI _gazeInteractorUI;
        ...
        public override void Start()
        {
            ...
            _transparentGizmo = Instantiate(GizmoTransparent,
                _indicatorGizmo.transform.position,
                Quaternion.identity,
                _indicatorGizmo.transform);
            _surfaceGizmo = Instantiate(GizmoSurface,
                _indicatorGizmo.transform.position,
                Quaternion.identity,
                _indicatorGizmo.transform);
        ...
        public void InstantiateGizmos()
        {
            ...
            if (!_placeAnchorAtRaycastHit || _target == null)
            {
                return;
            }
