...
namespace Agora_RTC_Plugin.API_Example.Examples.Basic.JoinChannelVideo
{
    public class JoinChannelVideo : MonoBehaviour
    {
        ...
        protected string ChannelName => _channelName;
...
#region -- Video Render UI Logic ---
        ...
        internal static void MakeVideoView(uint uid, string channelId = "", bool onPlane = false, Transform parent = null, GameObject prefab = null)
        {
            ...
            var videoSurface = !onPlane ? 
                MakeImageSurface(uid.ToString()) : 
                MakePlaneSurface(uid.ToString(), parent, prefab);
        ...
        private static VideoSurface MakePlaneSurface(string goName, Transform parent, GameObject prefab)
        {
            var go = prefab != null ?
                Instantiate(prefab) : 
